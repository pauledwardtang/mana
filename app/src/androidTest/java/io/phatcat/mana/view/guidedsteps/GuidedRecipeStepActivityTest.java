...
/**
 * Tests guided step activity
 */
@LargeTest
@RunWith(AndroidJUnit4ClassRunner.class)
public class GuidedRecipeStepActivityTest {

    @Rule
    public ActivityTestRule<RecipesActivity> mActivityTestRule = new ActivityTestRule<>(RecipesActivity.class);

    @Test
    public void guidedRecipeStepActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.description), withText("Recipe Introduction"), isDisplayed()));
